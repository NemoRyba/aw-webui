...
const GERMAN_MESSAGES: Record<string, string> = Object.assign(
  {},
  {
    ...
    Selection: 'Auswahl',
    'Load evaluation': 'Auswertung laden',
    ...
    'Show system load': 'Systemlast anzeigen',
    'No system metrics found for this range': 'Keine Systemmetriken für diesen Zeitraum gefunden',
    'Unable to load system metrics': 'Systemmetriken konnten nicht geladen werden',
    'No devices selected': 'Keine Geräte ausgewählt',
    Latest: 'Neueste',
    'Last hour': 'Letzte Stunde',
    'Last 2 hours': 'Letzte 2 Stunden',
    ...
    User: 'Benutzer',
    Admin: 'Admin',
    'Only admins can view this page.': 'Nur Admins koennen diese Seite sehen.',
    Navigation: 'Navigation',
    'Admin settings': 'Admin-Einstellungen',
    'Authentication and LDAP': 'Authentifizierung und LDAP',
    'Connect a Windows domain through LDAP. New LDAP users are created as non-admin users after their first successful login.':
      'Verbinde eine Windows-Domäne über LDAP. Neue LDAP-Benutzer werden nach der ersten erfolgreichen Anmeldung als Nicht-Admins angelegt.',
    'LDAP integration': 'LDAP-Integration',
    'Enable LDAP login': 'LDAP-Anmeldung aktivieren',
    'LDAP server URL': 'LDAP-Server-URL',
    'Windows domain': 'Windows-Domäne',
    'Used when users type only their short Windows username.':
      'Wird verwendet, wenn Benutzer nur ihren kurzen Windows-Benutzernamen eingeben.',
    'Base DN': 'Base DN',
    'Bind DN': 'Bind DN',
    'Optional service account used to find the user DN before checking the user password.':
      'Optionales Dienstkonto, um die Benutzer-DN zu finden, bevor das Benutzerpasswort geprüft wird.',
    'Bind password': 'Bind-Passwort',
    'Saved password unchanged': 'Gespeichertes Passwort bleibt unverändert',
    'Clear saved bind password': 'Gespeichertes Bind-Passwort löschen',
    'User search filter': 'Benutzer-Suchfilter',
    'Supported placeholders: {username}, {raw_username}, {upn}.':
      'Unterstützte Platzhalter: {username}, {raw_username}, {upn}.',
    'Save LDAP settings': 'LDAP-Einstellungen speichern',
    'Test LDAP login': 'LDAP-Anmeldung testen',
    'Test username': 'Test-Benutzername',
    'Test password': 'Test-Passwort',
    'Test LDAP': 'LDAP testen',
    'Testing...': 'Teste...',
    'If no test credentials are provided, only the service bind is tested.':
      'Wenn keine Test-Zugangsdaten angegeben werden, wird nur der Service-Bind getestet.',
    'Application admins': 'Anwendungs-Admins',
    'LDAP users appear here after their first successful login. They are non-admin until the built-in admin promotes them.':
      'LDAP-Benutzer erscheinen hier nach ihrer ersten erfolgreichen Anmeldung. Sie sind Nicht-Admins, bis der eingebaute Admin sie hochstuft.',
    'Refresh users': 'Benutzer aktualisieren',
    'Display name': 'Anzeigename',
    Source: 'Quelle',
    'Last login': 'Letzte Anmeldung',
    'Unable to load authentication settings':
      'Authentifizierungseinstellungen konnten nicht geladen werden',
    'Unable to load users': 'Benutzer konnten nicht geladen werden',
    'LDAP settings saved': 'LDAP-Einstellungen gespeichert',
    'Unable to save LDAP settings': 'LDAP-Einstellungen konnten nicht gespeichert werden',
    'LDAP test succeeded': 'LDAP-Test erfolgreich',
    'LDAP test failed': 'LDAP-Test fehlgeschlagen',
    'Unable to update user': 'Benutzer konnte nicht aktualisiert werden',
    ...
    'Uses only read-only SELECT queries against the Redmine database.':
      'Verwendet nur schreibgeschuetzte SELECT-Abfragen gegen die Redmine-Datenbank.',
    Driver: 'Treiber',
    Automatic: 'Automatisch',
    Host: 'Host',
    Port: 'Port',
    Database: 'Datenbank',
    'Table prefix': 'Tabellenpraefix',
    'mysql CLI path': 'mysql-CLI-Pfad',
    'Connection timeout': 'Verbindungs-Timeout',
    'Clear saved password': 'Gespeichertes Passwort loeschen',
    'Save Redmine settings': 'Redmine-Einstellungen speichern',
    'Test Redmine read access': 'Redmine-Lesezugriff testen',
    'Unable to load Redmine settings': 'Redmine-Einstellungen konnten nicht geladen werden',
    'Unable to save Redmine settings': 'Redmine-Einstellungen konnten nicht gespeichert werden',
    'Redmine settings saved': 'Redmine-Einstellungen gespeichert',
    'Redmine read access succeeded': 'Redmine-Lesezugriff erfolgreich',
    'Redmine read access failed': 'Redmine-Lesezugriff fehlgeschlagen',
    'Selected users': 'Ausgewaehlte Benutzer',
    'ActivityWatch active session time': 'ActivityWatch aktive Sitzungszeit',
    'Redmine booked time': 'Redmine gebuchte Zeit',
    'Redmine projects': 'Redmine-Projekte',
    '+ {count} more': '+ {count} weitere',
    Difference: 'Differenz',
    Redmine: 'Redmine',
    'Redmine loaded': 'Redmine geladen',
    'Select all': 'Alle auswaehlen',
    'Select none': 'Keine auswaehlen',
    'Load Redmine': 'Redmine laden',
    'Loading Redmine...': 'Redmine laedt...',
    'Redmine integration is disabled': 'Redmine-Integration ist deaktiviert',
    'Unable to load Redmine comparison': 'Redmine-Vergleich konnte nicht geladen werden',
    ...
    'No daily data found in the selected range.':
      'Fuer den gewaehlten Zeitraum wurden keine Tagesdaten gefunden.',
    'Verify Windows users against Redmine users and override the match when needed.':
      'Windows-Benutzer mit Redmine-Benutzern pruefen und bei Bedarf manuell uebersteuern.',
    'Windows user': 'Windows-Benutzer',
    'LDAP email': 'LDAP-E-Mail',
    'Automatic Redmine match': 'Automatische Redmine-Zuordnung',
    'Manual override': 'Manuelle Uebersteuerung',
    'Effective Redmine user': 'Wirksamer Redmine-Benutzer',
    Reason: 'Grund',
    'Automatic by email': 'Automatisch per E-Mail',
    'Redmine mapping saved': 'Redmine-Zuordnung gespeichert',
    'Unable to load Redmine mappings': 'Redmine-Zuordnungen konnten nicht geladen werden',
    'Unable to save Redmine mapping': 'Redmine-Zuordnung konnte nicht gespeichert werden',
    'manual override': 'manuell uebersteuert',
    'matched by email': 'per E-Mail zugeordnet',
    matched: 'zugeordnet',
    missing_email: 'E-Mail fehlt',
    manual_missing: 'manuelle Zuordnung fehlt',
    no_redmine_user: 'kein Redmine-Benutzer',
    ...
    Cancel: 'Abbrechen',
    Confirm: 'Bestätigen',
    'Showing {shown} events': '{shown} Ereignisse angezeigt',
    'Showing {shown} events (out of {total})': '{shown} Ereignisse angezeigt (von {total})',
    'Select shown': 'Angezeigte auswählen',
    'Selected: {count}': 'Ausgewählt: {count}',
    'Select event': 'Ereignis auswählen',
    'Delete selected': 'Ausgewählte löschen',
    'Deleting...': 'Löscht...',
    'Delete {count} selected events? This is permanent and cannot be undone.':
      '{count} ausgewählte Ereignisse löschen? Dies ist dauerhaft und kann nicht rückgängig gemacht werden.',
    'Failed to delete selected events. See server logs for more info.':
      'Ausgewählte Ereignisse konnten nicht gelöscht werden. Sieh für Details in die Server-Logs.',
    'Expand list': 'Liste erweitern',
    'Condense list': 'Liste verkleinern',
  ...
  },
  {
    ...
    'Categorize matching events': 'Passende Ereignisse kategorisieren',
    'Match from': 'Abgleichen nach',
    Target: 'Ziel',
    'Existing category': 'Bestehende Kategorie',
    'New category': 'Neue Kategorie',
    'Choose category': 'Kategorie wählen',
    'New category path': 'Neuer Kategoriepfad',
    ...
    'Selected category only matches other fields. Choose a compatible field or create a new category.':
      'Die ausgewählte Kategorie gleicht nur andere Felder ab. Wähle ein passendes Feld oder erstelle eine neue Kategorie.',
    'Existing category has no field scope; the new pattern can match any categorized field.':
      'Die bestehende Kategorie hat keine Feldeinschränkung; das neue Muster kann jedes kategorisierte Feld treffen.',
    Delete: 'Löschen',
    Save: 'Speichern',
    Randomize: 'Zufällig',
